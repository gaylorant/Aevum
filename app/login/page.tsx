  ...
  return (
    <>
      <style>{`
        ...
        .google-btn { transition: background 0.2s, border-color 0.2s, transform 0.15s !important; }
        .google-btn:hover { background: rgba(255,255,255,0.09) !important; border-color: rgba(255,255,255,0.2) !important; transform: scale(1.02) !important; }
      `}</style>
      ...
      <div style={{ minHeight: "100vh", background: "#070614", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Inter', sans-serif", position: "relative", overflow: "hidden" }}>
        ...
        {/* 4 corner blobs */}
        <div style={{ position: "fixed", width: 480, height: 480, top: -100, left: -100, background: "radial-gradient(circle,rgba(46,91,255,0.55) 0%,rgba(46,91,255,0.1) 55%,transparent 75%)", filter: "blur(72px)", animation: "blobDrift1 18s ease-in-out infinite", pointerEvents: "none" }} />
        <div style={{ position: "fixed", width: 440, height: 440, top: -80, right: -100, background: "radial-gradient(circle,rgba(0,206,209,0.5) 0%,rgba(0,206,209,0.08) 55%,transparent 75%)", filter: "blur(70px)", animation: "blobDrift2 22s ease-in-out infinite", pointerEvents: "none" }} />
        <div style={{ position: "fixed", width: 460, height: 460, bottom: -100, left: -80, background: "radial-gradient(circle,rgba(138,43,226,0.5) 0%,rgba(138,43,226,0.08) 55%,transparent 75%)", filter: "blur(72px)", animation: "blobDrift3 20s ease-in-out infinite", pointerEvents: "none" }} />
        <div style={{ position: "fixed", width: 420, height: 420, bottom: -80, right: -100, background: "radial-gradient(circle,rgba(0,255,204,0.45) 0%,rgba(0,255,204,0.08) 55%,transparent 75%)", filter: "blur(68px)", animation: "blobDrift4 24s ease-in-out infinite", pointerEvents: "none" }} />

        {/* Card */}
        <div className="login-card" style={{ position: "relative", zIndex: 10, width: "100%", maxWidth: 400, margin: "0 24px", background: "rgba(255,255,255,0.03)", backdropFilter: "blur(40px)", border: "1px solid rgba(255,255,255,0.07)", borderBottom: "1px solid rgba(203,190,255,0.15)", borderRight: "1px solid rgba(203,190,255,0.1)", borderRadius: 28, padding: "52px 40px", textAlign: "center", boxShadow: "0 32px 80px rgba(0,0,0,0.5)" }}>
